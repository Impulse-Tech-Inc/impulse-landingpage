...
export default {
  data() {
    return {
      ...
      showManyMore: false,
      moreVendors: ['Adtran', 'Juniper', 'Arista', 'Calix', 'Zhone', 'Nokia', 'GenieACS', 'VSOL', 'Ericsson', 'Extreme Networks', 'Fortinet', 'Palo Alto', 'Aruba', 'Ruckus', 'Cambium', 'Mimosa', 'Siklu', 'Radwin']
    }
  },
  computed: {
    allVendors() {
