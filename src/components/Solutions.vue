<template>
  <section ref="containerRef" class="relative bg-white transition-colors duration-500" style="height: 350vh">
    ...
    <div class="sticky top-0 h-screen w-full flex items-center overflow-hidden">
          ...
          >
            ...
            <div class="space-y-12">
              <div class="space-y-4">
                ...
                <h2 class="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-none tracking-tighter">
                  {{ currentPillar.name }}
                </h2>
                <p class="text-lg md:text-xl font-medium text-slate-700 tracking-tight max-w-lg">
                  {{ $t(currentPillar.titleKey) }}
                </p>
              </div>

              <div class="max-w-xl space-y-10">
                <p class="text-base md:text-lg text-slate-800 leading-relaxed font-medium">
                ...
                <div class="flex flex-wrap gap-x-10 gap-y-8 pt-4">
                  <div v-for="(s, si) in currentPillar.stats" :key="si" class="space-y-2 min-w-[100px]">
                    <div class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">{{ s.label }}</div>
                    <div class="text-base font-bold text-slate-900 tracking-tight">{{ s.value }}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="relative aspect-square flex items-center justify-center">
              ...
              <div class="relative z-10 w-full h-full flex items-center justify-center">
                ...
                <div v-if="activeIndex === 0" class="grid grid-cols-1 gap-4 w-full max-w-lg relative animate-scale-in">
                  ...
                  <div class="bg-white border border-slate-200 rounded-[2rem] p-6 shadow-2xl relative overflow-hidden flex flex-col justify-between h-[220px]">
                    ...
                    <div class="mt-3 text-[10px] font-bold text-slate-500 uppercase">CORE_UPTIME: 99.999%</div>
                  </div>

                  <div class="bg-white border border-slate-200 rounded-[1.5rem] p-5 shadow-2xl relative overflow-hidden h-[220px] flex flex-col">
                    ...
                    <div class="flex-1 grid grid-cols-3 gap-2">
                      <div
                        ...
                        :key="vendor"
                        class="flex items-center justify-center p-2 rounded-lg bg-slate-50 border border-slate-100 text-[9px] font-black uppercase tracking-tighter text-slate-600 animate-fade-up"
                    ...
                    <div class="mt-3 p-2 bg-slate-50/50 rounded-lg border border-slate-100 flex items-center justify-between">
                      <div class="flex items-center gap-2">
                        ...
                        <div class="text-[8px] font-black text-slate-900 uppercase tracking-wider">Unified Device Management</div>
                      </div>
                ...
                <div v-if="activeIndex === 1" class="grid grid-cols-1 gap-4 w-full max-w-lg relative animate-scale-in">
                  <div class="bg-white border-2 border-[#7F39E9]/30 rounded-[2rem] p-5 shadow-[0_20px_50px_rgba(127,57,233,0.2)] relative overflow-hidden flex flex-col h-[220px] z-20">
                    ...
                    <div class="flex-1 space-y-2">
                      ...
                      <div class="grid grid-cols-2 gap-2">
                        <button class="px-2 py-1.5 rounded-lg bg-slate-900 text-white text-[7px] font-black uppercase tracking-widest shadow-lg">New Ticket</button>
                        <button class="px-2 py-1.5 rounded-lg bg-white border border-slate-200 text-slate-900 text-[7px] font-black uppercase tracking-widest">Upgrade</button>
                      </div>
                    </div>
                  </div>

                  <div class="bg-white border border-slate-200 rounded-[2rem] p-6 shadow-2xl relative overflow-hidden h-[180px]">
                    <div class="flex justify-between items-start mb-4">
                    ...
                    <div class="text-2xl font-black text-slate-900 tracking-tighter">+$1.4M</div>
                ...
                <div v-if="activeIndex === 2" class="w-full max-w-md space-y-4 animate-scale-in">
                  <div class="flex gap-3 items-end animate-slide-left">
                    <div class="w-8 h-8 rounded-full bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-400">
                      <Icon icon="heroicons-outline:user" class="text-sm" />
                    </div>
                    <div class="px-5 py-3 rounded-[1.5rem] rounded-bl-sm bg-slate-100 border border-slate-200/50 text-xs text-slate-900 max-w-[80%] shadow-xl">
                  ...
                  <div class="flex flex-row-reverse gap-3 items-end animate-slide-right" style="animation-delay: 1s">
                    ...
                    <div class="space-y-3 max-w-[85%]">
                      ...
                      <div class="bg-white border border-slate-200 rounded-2xl p-5 shadow-2xl animate-fade-up" style="animation-delay: 2s">
                  ...
                  <div class="bg-teal-500 p-1 border border-black/5 rounded-[2rem] shadow-2xl relative overflow-hidden animate-fade-up" style="animation-delay: 3.5s">
                    <div class="bg-white rounded-[1.9rem] p-8 flex flex-col items-center gap-4">
                      ...
                      <div class="text-center space-y-1">
                        ...
                        <div class="text-[9px] font-black text-slate-500 uppercase tracking-[0.4em]">Signal Stable | Ticket #8042 Closed</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div v-if="activeIndex === 3" class="relative w-full max-w-xl h-full flex flex-col justify-center gap-6 py-8 px-4 animate-scale-in">
                  <div class="flex justify-center gap-8">
                    ...
                    >
                      <div
                        class="w-12 h-12 rounded-xl bg-white border border-slate-200 flex items-center justify-center relative overflow-hidden shadow-xl"
                        :style="{ color: s.color }"
                      >
                        <Icon :icon="s.icon" class="text-lg" />
                      </div>
                      <div class="text-center">
                        <div class="text-[8px] font-black text-slate-400 uppercase tracking-widest">{{ s.label }}</div>
                        <div class="text-[10px] font-black text-slate-900">{{ s.value }}</div>
                      </div>
                    </div>
                  </div>

                  <div class="bg-white border border-slate-200 rounded-[2.5rem] p-8 shadow-2xl backdrop-blur-2xl relative overflow-hidden">
                    <div class="absolute top-0 right-0 p-6 flex flex-col items-end">
                      <div class="text-[8px] font-black text-slate-300 uppercase tracking-[0.3em] mb-1">Live Session Rating</div>
                    ...
                    <div class="space-y-8">
                      <div>
                        <div class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3">Subscriber_Account: #TR-9004</div>
                        <div class="text-5xl font-black text-slate-900 tracking-tighter leading-none">$142.<span class="animate-blink">85</span></div>
                        <div class="text-[9px] font-bold text-slate-400 uppercase mt-3 flex items-center gap-2">
                      ...
                      <div class="space-y-2">
                        <div class="flex justify-between items-center p-4 bg-slate-50 rounded-xl border border-slate-200">
                          <div class="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div class="text-[10px] font-bold text-slate-900">Outage Detected: 2h 14m</div>
                            </div>
                          </div>
                        ...
                        <div class="flex justify-between items-center p-4 bg-slate-50 rounded-xl border border-slate-200">
                          <div class="flex items-center gap-3">
                            ...
                            <div>
                              <div class="text-[9px] font-black text-slate-400 uppercase tracking-widest">Dunning Sequence</div>
                              <div class="text-[10px] font-bold text-slate-900">Reminder Sent</div>
                            </div>
                          </div>
                ...
                <div v-if="activeIndex === 4" class="relative w-full h-full flex items-center justify-center px-4 py-8 animate-scale-in">
                  ...
                  <div class="relative z-10 w-full max-w-md bg-white border border-slate-200 rounded-[3rem] p-8 shadow-2xl overflow-hidden">
                    <div class="absolute inset-0 opacity-[0.03] bg-[radial-gradient(circle_at_center,rgba(127,57,233,0.5)_0%,transparent_70%)]" />
                    <div class="absolute inset-0 border border-[#7F39E9]/10 rounded-full border-dashed m-6 animate-spin-very-slow" />

                    <div class="relative z-10 space-y-8">
                      <div class="flex justify-between items-start">
                        <div class="space-y-1">
                          <div class="text-[8px] font-black text-[#7F39E9] uppercase tracking-[0.4em]">Strategic Command</div>
                          <h3 class="text-2xl font-black text-slate-900 tracking-tighter">Operational KPI Ownership</h3>
                        </div>
                        <div class="p-3 rounded-xl bg-[#7F39E9]/10 border border-[#7F39E9]/20 text-[#7F39E9] shadow-lg">
                      ...
                      <div class="grid grid-cols-2 gap-4">
                        <div class="p-4 bg-slate-50 border border-slate-100 rounded-2xl space-y-3">
                          <div class="flex justify-between items-center">
                            <span class="text-[7px] font-black text-slate-400 uppercase tracking-widest">Strategic Outcome</span>
                            <Icon icon="heroicons-outline:trending-up" class="text-teal-500 text-sm" />
                          </div>
                          <div class="text-xl font-black text-slate-900 tracking-tighter uppercase">Proven ROI</div>
                          <div class="h-1 w-full bg-slate-200 rounded-full overflow-hidden">
                            <div class="h-full bg-teal-500 animate-progress-85" />
                          </div>
                        </div>
                        <div class="p-4 bg-slate-50 border border-slate-100 rounded-2xl space-y-3">
                          <div class="flex justify-between items-center">
                            <span class="text-[7px] font-black text-slate-400 uppercase tracking-widest">Churn Target</span>
                            <Icon icon="heroicons-outline:cursor-click" class="text-teal-500 text-sm" />
                          </div>
                          <div class="text-xl font-black text-slate-900 tracking-tighter">-24%</div>
                          <div class="h-1 w-full bg-slate-200 rounded-full overflow-hidden">
                            <div class="h-full bg-teal-500 animate-progress-72" />
                          </div>
                        </div>
                      </div>

                      <div class="p-6 bg-slate-50 border border-slate-100 rounded-[2rem] space-y-4 relative overflow-hidden">
                        <div class="flex justify-between items-center">
                          <div class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-[#7F39E9] animate-pulse" />
                            <span class="text-[8px] font-black text-slate-500 uppercase tracking-widest">Network Audit</span>
                          </div>
                          <span class="text-[8px] font-mono text-[#7F39E9]">PHASE_04</span>
                        </div>
                        <div class="flex items-end gap-1 h-12">
                          <div
                            v-for="(h, i) in [60, 40, 85, 30, 95, 50, 70, 45, 80, 55, 90, 65]"
                            :key="i"
                            class="flex-1 bg-[#7F39E9]/15 border-t border-[#7F39E9]/40 rounded-t-sm animate-bar-reverse"
                            :style="{ height: `${h}%`, animationDelay: `${i * 0.05}s` }"
                          />
                        </div>
                        <div class="flex justify-between items-center text-[7px] font-black text-slate-400 uppercase tracking-widest">
                      ...
                      <div class="flex justify-center">
                        <button class="px-8 py-4 text-white text-[9px] font-black uppercase tracking-widest rounded-full shadow-2xl flex items-center gap-3 hover:scale-105 transition-transform" style="background: linear-gradient(224.95deg, #a446f4 -1.95%, #4138f3 104.5%)">
                    ...
                    <div class="absolute top-0 right-0 p-8 opacity-5">
                      <Icon icon="heroicons-outline:map" class="text-[#7F39E9] text-7xl" />
                    </div>
                  </div>
                </div>
      ...
      <div class="absolute bottom-8 left-1/2 -translate-x-1/2 z-50">
        <div class="flex items-center gap-8 lg:gap-12 px-8 lg:px-10 py-4 bg-white/95 rounded-full shadow-[0_10px_40px_rgba(0,0,0,0.12)] border border-slate-100 backdrop-blur-2xl">
          <button
          ...
          >
            <div
              ...
              :class="activeIndex === idx ? 'text-[#7F39E9]' : 'text-slate-900'"
            >
              {{ p.name }}
            </div>
            <div
              class="w-2.5 h-2.5 rounded-full transition-all duration-500"
              :class="activeIndex === idx ? 'scale-150' : 'bg-slate-300'"
